...
class LoggerFactory:
    ...
    @classmethod
    def get_logger(cls, name: str, level: int = logging.INFO, log_dir: Optional[str | Path] = None, console: bool = True, file_prefix: str = "app") -> logging.Logger:
        """
    ...
    @classmethod
    def _create_file_handler(cls, log_dir: str | Path, prefix: str) -> logging.FileHandler:
    ...
    @classmethod
    def get_notebook_logger(cls, name: str, log_dir: Optional[str | Path] = None) -> logging.Logger:
        """
